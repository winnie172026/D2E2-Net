...
class Options:
    def __init__(self, isTrain):
        ...
        self.dataset = 'TN'     # dataset: LC: Lung Cancer, MO: MultiOrgan
        self.ratio = 0.10
        ...
        self.train['train_epochs'] = 120        # number of training epochs
        ...
        self.train['crf_weight'] = 0.01          # weight for crf loss
