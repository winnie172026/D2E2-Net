...
data_dir = '../data/TN/original_images'
save_dir = '../data_for_train/TN/images_normalized_by_LC/test'
# data_dir = '../data/MO/original_images'
# save_dir = '../data_for_train/MO/images_normalized_by_LC/test'
os.makedirs(save_dir, exist_ok=True)

img_list = os.listdir('../data_for_train/TN/images/test')
# img_list = os.listdir('../data_for_train/MO/images/test')

ref_img_path = '../data/TN/images/193-a2-1.png'
#ref_img_path = '../data/MO/images/193-a2-1.png'
...
compute_mean_std(save_dir, '../data_for_train/TN', '193-a2-1')
